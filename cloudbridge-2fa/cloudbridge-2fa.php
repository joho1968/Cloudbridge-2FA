...
class Cloudbridge_2FA {
    ...
    public function cb2fa_settings() : void {
        ...
        add_settings_section( 'cb2fa-settings', '', false, 'cloudbridge-2fa' );
            ...
            add_settings_field( 'cloudbridge2fa-code-email-text-addon', esc_html__( 'OTP code entry text', 'cloudbridge-2fa' ), [$this, 'cb2fa_code_email_text_addon'], 'cloudbridge-2fa', 'cb2fa-settings', ['label_for' => 'cloudbridge2fa-code-email-text-addon'] );
